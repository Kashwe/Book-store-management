...
import { Container, Typography, Paper, Box, Button, TextField, Divider, Alert, Grid, InputAdornment, CircularProgress } from '@mui/material';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.response && err.response.data && err.response.data.message) {
        ...
        setApiError('Failed to update book. Please verify inputs or permissions.');
      }
    } finally {
